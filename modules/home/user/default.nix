...
in {
  options.${namespace}.user = {
    ...
    name = mkOpt (types.nullOr types.str) (config.snowfallorg.user.name or "dylan") "The user account.";
      ...
      assertions = [
        {
          ...
          message = "universe.user.name must be set";
        }
        {
          assertion = cfg.home != null;
          message = "universe.user.home must be set";
        }
      ];
